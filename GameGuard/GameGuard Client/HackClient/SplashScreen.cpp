...
void CSplash::OnPaint(HWND hwnd)
{
	...
	if(m_ShowText == 1)
	{
		HFONT hFont = CreateFont(15,0,0,0,FW_LIGHT,TRUE,FALSE,FALSE,DEFAULT_CHARSET,OUT_OUTLINE_PRECIS, CLIP_DEFAULT_PRECIS, CLEARTYPE_QUALITY, VARIABLE_PITCH, TEXT("Arial"));
		SelectObject(hDC, hFont);
		SetBkMode(hDC,TRANSPARENT);
		SetTextColor(hDC, m_TextColor);
		TextOutA(hDC, 160, 95, m_TextToDisplay, strlen(m_TextToDisplay));
	}
