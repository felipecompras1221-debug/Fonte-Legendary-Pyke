...
int Centralizado::MoveRenderCameraDefault()
{
	...
	{
		if (gInterface.Data[eCONFIRM_MAIN].OnShow || gInterface.Data[300].OnShow)
		{
		...
		if (gInterface.Data[eMenu_MAIN].OnShow ||
			...
			gCMacroUIEx.JEWELBANK_WINDOW->onShow ||
			gInterface.Data[eCONFIRM_MAIN].OnShow)
		{
			pSetCursorFocus = true;
		}
...
void RenderOptionText(int a1)
{
	...
	//--
	pDrawText(pTextThis(), x + 45, y + 100, "PVP Attack", 0, 0, (LPINT)1, 0); //-- HP Monster
...
char RenderPartyBack(DWORD a1)
{
	...
	if (gProtect.m_MainInfo.CustomInterfaceType == 0 || gProtect.m_MainInfo.CustomInterfaceType == 1 || gProtect.m_MainInfo.CustomInterfaceType == 2
		|| gProtect.m_MainInfo.CustomInterfaceType == 3 || gProtect.m_MainInfo.CustomInterfaceType == 4)
	{
		if (*(BYTE*)(a1 + 917))
		{
