...
void CLoginMainWin::CancelLogin1(void* thisa)
{
	if (AutoLogin.GetShowListAccount()) 
	{
		return;
...
void CLoginMainWin::LoadImages()
{
	...
	LoadBitmapA("Interface\\b_create.tga", 71620, GL_LINEAR, GL_CLAMP, 1, 0);
	LoadBitmapA("Custom\\Interface\\login_back.tga", 71631, GL_LINEAR, GL_CLAMP, 1, 0);
}

void CLoginMainWin::Init()
{
	SetDword(0x0040C989 + 3, 2);
	...
	SetCompleteHook(0xE8, 0x0040B422, CLoginMainWin::CancelLogin1);
	SetCompleteHook(0xE8, 0x0040B47C, CLoginMainWin::CancelLogin1);
