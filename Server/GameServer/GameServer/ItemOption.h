...
enum eItemOption
{
	...
	//
	ITEM_OPTION_ADD_TRIPLE_DAMAGE_RATE = 128,
	ITEM_RESIST_DOUBLE_DAMAGE_RATE = 129,
	ITEM_RESIST_IGNORE_DEFENSE_RATE = 130,
	ITEM_RESIST_IGNORE_SHIELD_RATE = 131,
	ITEM_RESIST_CRITICAL_DAMAGE_RATE = 132,
	ITEM_RESIST_EXCELLENT_DAMAGE_RATE = 133,
	ITEM_RESIST_STUN_RATE = 134,
};
