...
BOOL __stdcall pWingsIs(__int16 a1)
{
	return a1 == 8192;
}
...
extern "C" _declspec(dllexport) void EntryProc() // OK
{
	...
	SetCompleteHook(0xE8, 0x007E52E5, &pWingsIs); //Fix 380 wings
	...
	//	ShellExecuteA(NULL, "open", "Jogar Legendary [Mu].exe", 0, 0, SW_SHOW);
	//	ExitProcess(0);
	//}
	//==========================================================================================================
	//==========================================================================================================
	...
	SetDword(0x00634141 + 1, (DWORD)"Data\\Local\\NpcName.txt"); //NpcName.bmd
	...
	//-- Loading MuArchangel 2
	gCUIMng.Load();

	if (gProtect.m_MainInfo.SelectServerPosition == 0)
	{
		g_ServerSelWin.Init();
	}
