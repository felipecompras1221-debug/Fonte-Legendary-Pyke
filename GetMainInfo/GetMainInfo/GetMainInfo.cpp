...
int _tmain(int argc,_TCHAR* argv[]) // OK
{
	...
	info.SelectServerPosition = GetPrivateProfileInt("Custom", "SelectServerPosition ", 0, ".\\MainInfo.ini");
	...
	info.DailyReward = GetPrivateProfileInt("DailyReward", "DailyRewardSwitch", 0, ".\\MainInfo.ini");
	//-- MaxGameInstances Main.exe
